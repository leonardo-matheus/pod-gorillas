...
async function main() {
  ...
  const v400mix = await prisma.product.create({
    data: {
      ...
      price: 45.00,
      puffs: 400,
      images: JSON.stringify(['/products/v400-mix.png']),
  ...
  const v400 = await prisma.product.create({
    data: {
      ...
      price: 42.00,
      puffs: 400,
      images: JSON.stringify(['/products/v400.png']),
  ...
  const v300 = await prisma.product.create({
    data: {
      ...
      price: 38.00,
      puffs: 300,
      images: JSON.stringify(['/products/v300.png']),
  ...
  const v155 = await prisma.product.create({
    data: {
      ...
      price: 32.00,
      puffs: 155,
      images: JSON.stringify(['/products/v155.png']),
  ...
  const elfbarGH = await prisma.product.create({
    data: {
      ...
      price: 95.00,
      puffs: 23000,
      images: JSON.stringify(['/products/elfbar-gh-23k.png']),
  ...
  const elfbarTE = await prisma.product.create({
    data: {
      ...
      price: 110.00,
      puffs: 30000,
      images: JSON.stringify(['/products/elfbar-te-30k.png']),
  ...
  const elfbarIceKing = await prisma.product.create({
    data: {
      ...
      price: 130.00,
      puffs: 40000,
      images: JSON.stringify(['/products/elfbar-ice-king-40k.png']),
  ...
  // Elfbar Trio 40K - R$123 (preço informado)
  const elfbarTrio = await prisma.product.create({
    data: {
      ...
      price: 123.00,
      puffs: 40000,
      images: JSON.stringify(['/products/elfbar-trio-40k.png']),
  ...
  const oxbarKit = await prisma.product.create({
    data: {
      ...
      price: 115.00,
      puffs: 32000,
      images: JSON.stringify(['/products/oxbar-svopp-32k.png']),
  ...
  await prisma.settings.create({
    data: {
      ...
      storePhone: '16999999999',
      storeWhatsApp: '5516999999999',
